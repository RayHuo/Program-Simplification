...
for ((i=0; i<num; i++));
do
    echo ${pre}${lbrFiles[i]}, ${type}
    ./programsimplification ${pre}${lbrFiles[i]} ${type}
done
...
for ((i=0; i<num; i++));
do
    echo ${pre}${mtFiles[i]}, ${type}
    ./programsimplification ${pre}${mtFiles[i]} ${type}
done
...
for ((i=0; i<num; i++));
do
    echo ${pre}${scfFiles[i]}, ${type}
    ./programsimplification ${pre}${scfFiles[i]} ${type}
done
